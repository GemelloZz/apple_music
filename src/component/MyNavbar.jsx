...
import { Navbar, Nav, Container, Form, FormControl, Button, Col, Row } from "react-bootstrap";
...
const MyNavbar = () => {
  return (
    <>
      <Navbar bg="dark" expand="lg" className="shadow-sm custom-navbar delete">
        <Container className="my-0">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Form className="d-flex">
              <FormControl type="search" placeholder="Ascolta......" className="me-2" aria-label="Search" />
